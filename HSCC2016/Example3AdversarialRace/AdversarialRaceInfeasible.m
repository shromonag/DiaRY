%% Running Example 3: Adversarial Race(Infeasible)
...
%% STL formula
DiagSC.BluSTLsys.stl_list = {'alw_[0,inf] ( (x4(t) > 0.5) => (x2(t) > 0.5))'};
...
DiagSC = diagRun_adversarial(DiagSC, controller, adversary);
fprintf('\ndone.\n');
