...
sys.add_constraint(always(P('abs(u(t, 2))<=3.5')));
sys.add_constraint(always(P('abs(x(t, 4))<=1.53')));
...
[x, u, y] = sys1.signals();
sys1.add_constraint(P('x(0)==[-0.2; 1.5; pi/2; 0.5]'));
...
[x, u, y] = sys3.signals();
sys3.add_constraint(P('x(0)==[0.2; 1.5; pi/2; 0]'));
