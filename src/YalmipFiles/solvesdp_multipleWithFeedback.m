function [diagnostic, reordering, ConsFExpandMapping, mapF] = solvesdp_multipleWithFeedBack(varargin);
reordering = [];
ConsFExpandMapping = [];
mapF = [];
yalmiptime = clock;
...
yalmiptime = clock;
[model, reordering, ConsFExpandMapping, mapF] = solvesdpWithFeedBack(varargin{:});
