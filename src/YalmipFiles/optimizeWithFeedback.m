function [diagnostic, reordering, ConsFExpandMapping, mapF] = optimizeWithFeedback(varargin)
...
[diagnostic, reordering, ConsFExpandMapping, mapF] = solvesdpWithFeedback(varargin{:});
